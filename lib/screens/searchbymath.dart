...
class Searchbymath extends StatefulWidget {
  const Searchbymath({super.key});

  @override
  State<Searchbymath> createState() => _SearchbymathState();
}

class _SearchbymathState extends State<Searchbymath> {
  ...
  searcher({required String searchNumber}) async {
    ...
    String url = "http://numbersapi.com/$searchNumber/math?json";
            ...
            child: Form(
              ...
              child: TextFormField(
                ...
                decoration: InputDecoration(
                    ...
                    prefixIconColor: const Color.fromARGB(204, 2, 140, 126),
                      ...
                      children: [
                        InkWell(
                          onTap: () {
                            ...
                            mathList.add(mapresponse!["text"]);
                            mathList = mathList.toSet().toList();
                            box.put("math", mathList);
                            mathList = box.get("math") ?? [];
